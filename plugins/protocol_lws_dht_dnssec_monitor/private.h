...
struct monitor_req_args {
	 ...
	 * hints from the UI.  They resolve ${EXTIP4} / ${EXTIP6} records in
	 * zonefiles to real addresses for the inventory; empty strings when
	 * the client does not know them yet
	 */
	char ip4[64];
	char ip6[64];
};
